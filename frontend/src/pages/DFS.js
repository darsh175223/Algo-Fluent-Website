...
const DFSVisualizer = () => {
  ...
  const generateGraph = () => {
    ...
    // First, connect each level to ensure a connected graph
  ...
  const startDFS = () => {
    ...
    const stack = [1];  // Start from node 1
  ...
  return (
    <div style={styles.mainContainer}>
      ...
      <div style={styles.infoPanel}>
        <h3 style={styles.infoHeader}>How Depth First Search Works:</h3>
        <p style={styles.infoText}>
          Depth First Search (DFS) is a graph traversal algorithm that explores as far as possible along each branch before backtracking. It uses a stack to keep track of nodes to visit. The algorithm starts at a root node and explores as far as possible along each branch before backtracking.
        </p>
        <p style={styles.infoText}>
